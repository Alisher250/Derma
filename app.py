...
from findpercentage import execute1
...
def causes():
    ...
    return render_template('causes.html', form=form, x=x, x1=x1, x2=x2,d1=d1,da1=da1,im1=im1,imp1=imp1,maxdt=maxdt,it1=it1,imt1=imt1,dt=dt,pm=pm)
